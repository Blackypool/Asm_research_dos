...
;{
        ...
        pop si      ; ramki_netu comeback
        pop ax

        iret

 ;_________ramka_is_alredy_paint

    ramka_est:
        push es             ; vm
        push bx             ; ox_oy in vm

        mov bx, 336          ; 320 = start pose + 16 // 16)

        mov ax, 0b800h
        mov es, ax          

        mov si, 03h         ; to cmp with heart
        ...
        ;____________second_buff update for renessans
